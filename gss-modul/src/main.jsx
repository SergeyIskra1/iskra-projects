...
const services = [
  ...
  { title: 'Электрика', slug: 'elektrika', text: 'Заложим электрические точки, освещение, щиты и подготовку к подключению.', details: 'В расчете отдельно фиксируются точки подключения, освещение, щит, розетки и дополнительные нагрузки.' },
...
const workStages = [
  ...
  ['02', 'Расчет', 'Готовим расчет с НДС, отдельно считаем доставку, монтаж, фундамент и коммуникации.'],
...
const faq = [
  ...
  ['Цены указаны с НДС?', 'Да, цены указаны с НДС, расчет также готовится с НДС. Доставка, монтаж, фундамент и коммуникации считаются отдельно.'],
  ...
  ['Что нужно для расчета?', 'Размер, комплектация Эконом или Стандарт, назначение, количество модулей, регион и список нужных услуг.'],
];

const products = [
  { title: 'Блок-контейнер 6 x 2.4 м', slug: 'bk-6x24', category: 'blok-konteynery', price: 'от 164 400 ₽ с НДС', meta: '1 модуль · комплектация Эконом' },
  { title: 'Блок-контейнер 12 x 2.4 м', slug: 'bk-12x24', category: 'blok-konteynery', price: 'от 282 000 ₽ с НДС', meta: '1 модуль · комплектация Эконом' },
...
const economyComponents = [
  'сварной каркас из гнутого швеллера и уголка',
  'наружный металл, профлист и грунт-эмаль',
  'деревянное основание: брус и доска пола',
  'утеплитель 50 мм и ПВХ-пленка',
  'внутренняя обшивка ДСП и ПВХ-панелями',
  'линолеум, плинтусы, углы и соединители',
  'ПВХ-окно 700 x 900 и металлическая дверь',
  'базовая электрика и расходные материалы',
];
  ...
  return (
    <section className="hero section">
      <div className="hero-copy">
        ...
        <p>
          Производим бытовки, блок-контейнеры, модульные домики на собственном
          заводе. Сварной каркас, контроль на каждом этапе, доставка и монтаж по
          всей стране.
        </p>
        ...
        <div className="hero-points">
          <span>Бытовки, блок-контейнеры и модульные домики под разные задачи</span>
          <span>Собираем объект из одного или нескольких блок-контейнеров</span>
          <span>Доставка, монтаж и инженерные работы по всей стране</span>
        </div>
      </div>
    ...
    <section className="section two-col">
      <div>
        ...
        <p>
          ...
          бытового городка, частного участка или нестандартного проекта. Если
          нужен индивидуальный размер, менеджер рассчитает его по задаче клиента.
        </p>
        <div className="hero-actions">
      ...
      <div className="trust-list">
        <div><strong>Бизнес</strong><span>офисы, АБК, КПП, бытовые городки и технические помещения</span></div>
        <div><strong>Частным</strong><span>бытовки, модульные домики и индивидуальные решения</span></div>
        <div><strong>Закупки</strong><span>КП, расчет и документы по требованиям закупочной документации</span></div>
    ...
    <section className="section muted-section">
      <div className="section-head">
        <div>
          ...
          <p>Расчет зависит от параметров объекта и состава работ. Чем точнее исходные данные, тем быстрее менеджер подготовит предложение.</p>
        </div>
        <button className="primary" onClick={() => onLead('Получить расчет')}>Получить расчет</button>
      </div>
...
function ContainerComposition() {
  return (
    <section className="section">
      <div className="section-head">
        <div>
          <span className="kicker">Комплектация</span>
          <h2>Из чего состоит контейнер Эконом</h2>
          <p>Стандарт собирается из того же набора элементов, но отличается более высоким уровнем материалов и исполнения.</p>
        </div>
      </div>
      <div className="component-grid">
        {economyComponents.map((item) => (
          <div className="component-card" key={item}>{item}</div>
        ))}
      </div>
    </section>
  );
  ...
  return (
    <section className="section two-col" id="about-preview">
      ...
      <div className="trust-list">
        ...
        <div><strong>03</strong><span>Расчеты с НДС для бизнеса и закупок</span></div>
  ...
  return (
    <section className="section">
      ...
      <div className="trust-grid">
        ...
        <div className="trust-card">
          <h3>Документы</h3>
          <p>Предоставляем данные по компании, договору, НДС, комплектации и требованиям к поставке для согласования заказа.</p>
        </div>
        <div className="trust-card">
    ...
    <section className="section muted-section">
      <div className="section-head">
        <div>
          ...
          <h2>Ответы на вопросы перед запросом расчета</h2>
        </div>
      </div>
...
function ObjectPage({ slug, onLead }) {
  ...
  const tabContent = {
    ...
    equipment: ['Комплектация', 'Эконом и Стандарт собираются из одного набора элементов: каркас, обшивка, утепление, отделка, окно, дверь и базовая электрика. Стандарт отличается более высоким уровнем материалов и исполнения.'],
    delivery: ['Доставка и монтаж', 'Доставка, разгрузка, монтаж, фундамент и подключение коммуникаций считаются отдельно и добавляются в расчет при необходимости.'],
  };
  ...
  return (
    ...
    >
      ...
      <div className="object-info-grid">
        ...
        <div><strong>НДС</strong><span>Расчет и цена указываются с НДС</span></div>
    ...
    >
      <div className="two-col">
        <div className="content-block">
          ...
          <p>Подготавливаем расчеты с НДС, коммерческие предложения, реквизиты и документы для согласования. Для тендерных и корпоративных заказчиков важны прозрачные условия, сроки и состав поставки.</p>
    ...
    return (
      ...
      >
        <div className="content-block article-body">
          ...
          <p>Для первичного расчета менеджеру нужны назначение объекта, желаемые размеры, количество модулей, комплектация Эконом или Стандарт, регион поставки и список дополнительных работ: доставка, монтаж, фундамент, электрика, водоснабжение или канализация.</p>
    ...
    >
      ...
      <div className="contacts-layout">
        <div className="content-block">
          ...
          <h2>Для тендеров</h2>
          <p>Можно отправить ТЗ, требования закупки или проект. Подготовим данные для расчета и коммерческого предложения.</p>
        </div>
...
function FinalCta({ onLead }) {
  return (
    <section className="section final-cta">
      ...
      <p>Опишите задачу: размер, комплектацию Эконом или Стандарт, количество модулей, регион поставки и нужные услуги. Подготовим расчет под ваше ТЗ.</p>
      <button className="primary" onClick={() => onLead('Получить расчет')}>Получить расчет</button>
    </section>
  );
}
